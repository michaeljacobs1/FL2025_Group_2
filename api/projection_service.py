...
class ProjectionCalculator:
    ...
    def _load_user_data(self):
        ...
        self.income_entries = IncomeEntry.objects.filter(user=self.user).order_by('year')
    ...
    def calculate_projection(self, scenario_id: int, projected_years: int) -> ProjectionResult:
    ...
    def _calculate_yearly_projection(self, initial_balance: Decimal, annual_contribution: Decimal, 
                                   years: int, return_rate: Decimal, inflation_rate: Decimal) -> List[Dict]:
        ...
        for year in range(1, years + 1):
            ...
            inflation_adjusted_balance = current_balance / Decimal(str(inflation_factor))
    ...
    def _calculate_asset_allocation_ratios(self, scenario_type: str) -> Dict[str, Decimal]:
    ...
    def compare_scenarios(self, scenario_ids: List[int], projected_years: int) -> List[Dict]:
